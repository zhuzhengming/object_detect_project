...
#define MAX_IMAGE_DATA_SIZE (4 * 2048 * 3072)
    ...
    bool Camera::set(CamerProperties type, float value)
    {
        ...
        case CAP_PROP_FRAMERATE_ENABLE:
        {
            ...
            nRet = MV_CC_SetBoolValue(handle, "AcquisitionFrameRateEnable", (int)value);
        ...
        case CAP_PROP_BURSTFRAMECOUNT:
        {
            ...
            nRet = MV_CC_SetIntValue(handle, "AcquisitionBurstFrameCount", (int)value);
        ...
        case CAP_PROP_HEIGHT:
        {
            ...
            nRet = MV_CC_SetIntValue(handle, "Height", (int)(value)); //图像高度
        ...
        case CAP_PROP_WIDTH:
        {
            ...
            nRet = MV_CC_SetIntValue(handle, "Width", (int)(value)); //图像宽度
        ...
        case CAP_PROP_OFFSETX:
        {
            ...
            nRet = MV_CC_SetIntValue(handle, "OffsetX", (int)value); //图像宽度
        ...
        case CAP_PROP_OFFSETY:
        {
            ...
            nRet = MV_CC_SetIntValue(handle, "OffsetY", (int)value); //图像宽度
        ...
        case CAP_PROP_GAMMA_ENABLE:
        {
            ...
            nRet = MV_CC_SetBoolValue(handle, "GammaEnable", (int)value); //伽马因子是否可调  默认不可调（false）
        ...
        case CAP_PROP_GAINAUTO:
        {
            ...
            nRet = MV_CC_SetEnumValue(handle, "GainAuto", (int)value); //亮度 越大越亮
        ...
        case CAP_PROP_SATURATION_ENABLE:
        {
            ...
            nRet = MV_CC_SetBoolValue(handle, "SaturationEnable", (int)value); //饱和度是否可调 默认不可调(false)
        ...
        case CAP_PROP_SATURATION:
        {
            ...
            nRet = MV_CC_SetIntValue(handle, "Saturation", (int)value); //饱和度 默认128 最大255
        ...
        case CAP_PROP_TRIGGER_MODE:
        {
            ...
            nRet = MV_CC_SetEnumValue(handle, "TriggerMode", (int)value); //饱和度 默认128 最大255
        ...
        case CAP_PROP_TRIGGER_SOURCE:
        {
            ...
            nRet = MV_CC_SetEnumValue(handle, "TriggerSource", (int)value); //饱和度 默认128 最大255255
        ...
        case CAP_PROP_LINE_SELECTOR:
        {
            ...
            nRet = MV_CC_SetEnumValue(handle, "LineSelector", (int)value); //饱和度 默认128 最大255
    ...
    bool Camera::reset()
    {
        ...
        nRet = this->set(CAP_PROP_FRAMERATE, (float)FrameRate) || nRet;
        // nRet = this->set(CAP_PROP_BURSTFRAMECOUNT, BurstFrameCount) || nRet;
        nRet = this->set(CAP_PROP_HEIGHT, (float)height) || nRet;
        nRet = this->set(CAP_PROP_WIDTH, (float)width) || nRet;
        nRet = this->set(CAP_PROP_OFFSETX, (float)Offset_x) || nRet;
        nRet = this->set(CAP_PROP_OFFSETY, (float)Offset_y) || nRet;
        nRet = this->set(CAP_PROP_EXPOSURE_TIME, (float)ExposureTime) || nRet;
        nRet = this->set(CAP_PROP_GAMMA_ENABLE, GammaEnable) || nRet;
        nRet = this->set(CAP_PROP_GAMMA, Gamma) || nRet;
        nRet = this->set(CAP_PROP_GAINAUTO, (float)GainAuto) || nRet;
        nRet = this->set(CAP_PROP_SATURATION_ENABLE, SaturationEnable) || nRet;
        nRet = this->set(CAP_PROP_SATURATION, (float)Saturation) || nRet;
        nRet = this->set(CAP_PROP_TRIGGER_MODE, (float)TriggerMode) || nRet;
        nRet = this->set(CAP_PROP_TRIGGER_SOURCE, (float)TriggerSource) || nRet;
        nRet = this->set(CAP_PROP_LINE_SELECTOR, (float)LineSelector) || nRet;
        return nRet;
    }
