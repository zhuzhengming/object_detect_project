...
//     // h6020s[i].posPID.ref = 60;

//     // //位置伺服PID计算，两层PID
//     // h6020s[i].posPID.cur_error = h6020s[i].posPID.ref - h6020s[i].posPID.fdb;   //error
//     // h6020s[i].posPID.output = h6020s[i].posPID.KP * h6020s[i].posPID.cur_error;     //比例控制
//     // if( fabs(h6020s[i].posPID.output) > h6020s[i].posPID.outputMax ) h6020s[i].posPID.output = _SIGN(h6020s[i].posPID.output) * h6020s[i].posPID.outputMax;
...
//  h6020s[1].posPID.fdb = h6020s[1].FdbData.rpm;
//  h6020s[1].speedPID.ref = 2000;
//  PID_Calc(&h6020s[1].speedPID);

	

	h6020s[1].posPID.fdb = h6020s[1].FdbData.RotorAngle_0_360;
        h6020s[1].posPID.ref = posRef;
        P_Calc(&h6020s[1].posPID);

        // h6020s[1].speedPID.fdb = h6020s[1].FdbData.rpm;
        h6020s[1].speedPID.ref = h6020s[1].posPID.output;
